...
set tags+=/home/ubuntu-xOpenLee/study/git/python/cpython-master/tags
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
    elseif &filetype == 'html'
		...
		call append(line(".")+1, "	> Author: xOpenLee") 
		call append(line(".")+2, "	> Mail: 750haige@gmail.com ") 
    ...
    if &filetype == 'html'
        ...
        call append(line(".")+7, "<head lang=\"en\">")
        call append(line(".")+8, "<meta charset=\"UTF-8\">")
        call append(line(".")+9, "<title></title>")
...
func FormartSrc()
    exec "w"
    if &filetype == 'c'
        exec "!astyle --style=linux -a --suffix=none %"
